...
public class SelectionWindow3 extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9084738391817247166L;
	...
	public static void main(String[] args) {
		try {
			SelectionWindow3 dialog = new SelectionWindow3();
